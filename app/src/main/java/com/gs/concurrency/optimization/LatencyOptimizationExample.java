package com.gs.concurrency.optimization;
...
public class LatencyOptimizationExample {
  private static final String SOURCE_FILE = "/images/many-flowers.jpg";
  ...
  public static void main(String[] args) throws IOException {
    ...
    BufferedImage originalImage =
        ImageIO.read(
            Objects.requireNonNull(
                LatencyOptimizationExample.class.getResourceAsStream(SOURCE_FILE)));
    ...
    String outDir = LatencyOptimizationExample.class.getResource("/images/out").getFile();
    File outputFile = new File(outDir + DESTINATION_FILE);
